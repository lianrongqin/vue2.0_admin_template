(function () {
	...
	var fontD = new FontFaceObserver('SourceHanSansCN');
	var fontE = new FontFaceObserver('SourceHanSansCN', {
		weight: 200
	});
	var fontF = new FontFaceObserver('SourceHanSansCN', {
		weight: 300
	});
	var fontG = new FontFaceObserver('SourceHanSansCN', {
		weight: 500
	});

	var fontArialD = new FontFaceObserver('Arial');
	var fontArialN = new FontFaceObserver('Arial', {
		weight: 300
	});
	var fontArialB = new FontFaceObserver('Arial', {
		weight: 500
	});
	var fontArialI = new FontFaceObserver('Arial', {
		style: 'italic'
	});
	var fontArialBI = new FontFaceObserver('Arial', {
		weight: 500,
		style: 'italic'
	});
	var fontCenturyGothicD = new FontFaceObserver('Century Gothic');
	var fontCenturyGothicN = new FontFaceObserver('Century Gothic', {
		weight: 300
	});
	var fontCenturyGothicB = new FontFaceObserver('Century Gothic', {
		weight: 500
	});
	var fontADAMCG_D = new FontFaceObserver('ADAM');
	var fontADAMCG_N = new FontFaceObserver('ADAM', {
		weight: 300
	});
	...
	Promise.all([
		...
		fontArialI.load(),
		fontArialBI.load(),
		fontCenturyGothicD.load(),
		fontCenturyGothicN.load(),
		fontCenturyGothicB.load(),
		fontADAMCG_D.load(),
		fontADAMCG_N.load()
